    ...
    <div className="px-3 py-5 mt-10 mx-auto w-[80%] border-2 border-black rounded-lg lg:w-[30%]">
        ...
        <div className="px-3 mt-4">
            <form onSubmit={handleSubmit}>
                ...
                <br></br>
                <button disabled={loading} className={`${loading?'bg-blue-500 hover:bg-blue-500 cursor-none':null} text-lg gap-3 flex items-center justify-center  bg-blue-600 text-white py-1 rounded-lg cursor-pointer hover:bg-blue-700 w-[100%]`} type="submit">
                  {
