        ...
        <div className="mt-3 bg-gray-200 rounded-lg p-2 flex flex-col justify-center items-center">
          ...
          <div className="relative size-40 mt-2">
            <svg className="rotate-[135deg] size-full" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
              <circle cx="18" cy="18" r="16" fill="none" className="stroke-current text-gray-200 dark:text-neutral-700" stroke-width="1.5" stroke-dasharray="100 100" stroke-linecap="round"></circle>

              <circle cx="18" cy="18" r="16" fill="none" className="stroke-current text-blue-600 dark:text-blue-500" stroke-width="1.5" stroke-dasharray='90 100' stroke-linecap="round"></circle>
            </svg>
